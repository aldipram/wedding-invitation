...
const Tanggal = () => {
  return (
    <section className="bg-gradient-to-r from-blue-100 to-blue-300">
        <div data-aos="fade-in" data-aos-duration="1000" className="max-w-[476px] mx-auto bg-tanggal h-screen bg-no-repeat bg-cover shadow-xl shadow-black">
            <div className='w-[90%] mx-auto flex flex-col justify-center items-center h-screen backdrop-blur-sm'>
                ...
                <Link data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000" data-aos-delay="1400" to={"/lokasi"} className='flex items-center py-2 px-4 bg-[rgb(133,178,255)] rounded-full mt-5 text-white text-lg'>
